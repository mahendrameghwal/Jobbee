...
import {setCity,setCountry,setState, setField,setNewSkills,addSkill,removeskills, setNewResponsibility, addResponsibility, resetState} from '../../../app/slices/CreateJobSlice';
...
const Createjob =React.memo(() => {  
  ...
  const handleLoadMore = useCallback(() => {setVisibleCities((prevVisibleCities) => prevVisibleCities + 500)},[])
  return (
    ...
    <input required onChange={handleChange}   value={Job.salary}   placeholder="salary" className=" focus:ring-1 ring-blue-500 rounded-md outline-none border placeholder:text-gray-400 border-gray-300 bg-slate-100 max-md:px-2 max-md:py-1.5 px-4 py-2.5 w-full" type="text" name="salary"  />
    <br />
...
<span className="absolute -start-full  transition-all group-hover:start-4"><img src={submit} className="h-6" alt="submit" /></span>
