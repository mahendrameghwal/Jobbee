...

{
    first && 
    first.map((x,i)=>(
        <div key={i} onClick={()=>{navigate(`/findjobs/job-description/${x}`)}} className=" m-2 hover:shadow-xl p-2 rounded-xl transition-shadow duration-150 shadow-sm cursor-pointer border border-gray-200  bg-blue-50 ">
<div>
<div className="flex px-1 items-center justify-between">
<img className="h-10 rounded-md " src="https://img.naukimg.com/logo_images/groups/v1/4628151.gif" alt="" />
<span className="text-gray-500">2 days ago</span>
