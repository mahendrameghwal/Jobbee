...
const Footer = () => {
  return (
    <div className="bottom-0 ">
      ...
      <footer className="p-4 mt-0.5 sm:p-6 bg-gray-900">
        <div className="md:flex md:justify-between">
          <div className=" md:mb-2 py-2">
            <div className="flex items-center ">
              <img src={logo} className="mr-4 h-10" alt="FlowBite Logo"/>
              <span className="self-center text-xl font-semibold whitespace-nowrap text-white">JobBee</span>
            </div>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center ">© 2023 <span href="https://flowbite.com"  className="hover:underline">💖 designed by Mahendra</span>. All Rights Reserved.
    </span>
